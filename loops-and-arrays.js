...
for (square in squares){
    originalNumber = squares[number]
    volumeNumber = squares[number] * originalNumber * originalNumber
    console.log("Het volume van %d is %d", originalNumber, volumeNumber);
    number = number + 1
}